...
/**
 * Activity to handle searching babelio for books that did not automatically convert. These
 * are typically books with no ISBN.
 * 
 * The search criteria is setup to contain the book author, title and ISBN. The user can edit
 * these and search babelio, then review the results.
 * 
 * @author Philip Warner
 */
public class BabelioSearchCriteria extends BookCatalogueActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDbHelper.open();
		setContentView(R.layout.babelio_search_criteria);
	...
	private void doSearch() {
		...
		Intent i = new Intent(this, BabelioSearchResults.class);
		i.putExtra(BabelioSearchResults.SEARCH_CRITERIA, criteria);
