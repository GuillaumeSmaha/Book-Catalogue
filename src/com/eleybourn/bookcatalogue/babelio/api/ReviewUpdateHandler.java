...
public class ReviewUpdateHandler extends ApiHandler {
	...
	public ReviewUpdateHandler(BabelioManager manager) {
		super(manager);
	}
	...
	{
		HttpPost post = new HttpPost("http://www.babelio.com/review/" + reviewId + ".xml");
		...
		// Note a lot of point...it does not update babelio!
