...
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.ADDED;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.AUTHORS;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_AUTHOR_ID;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_AUTHOR_NAME;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_DESCRIPTION;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_FORMAT;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_ISBN;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_NOTES;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_PAGES;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_PUBLISHER;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_RATING;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_READ_END;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_READ_START;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.DB_TITLE;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.END;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.BA_BOOK_ID;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.BA_REVIEW_ID;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.ISBN13;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.LARGE_IMAGE;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.PUB_DAY;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.PUB_MONTH;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.PUB_YEAR;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.REVIEWS;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.SHELF;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.SHELVES;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.SMALL_IMAGE;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.START;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.TOTAL;
import static com.eleybourn.bookcatalogue.babelio.api.ListReviewsApiHandler.ListReviewsFieldNames.UPDATED;
...
import com.eleybourn.bookcatalogue.babelio.api.SimpleXmlFilter.BuilderContext;
import com.eleybourn.bookcatalogue.babelio.api.SimpleXmlFilter.XmlListener;
...
public class ListReviewsApiHandler extends ApiHandler {
	...
	public ListReviewsApiHandler(BabelioManager manager) {
		super(manager);
		if (!manager.validateCredentials())
			throw new RuntimeException("Babelio credentials not valid");
					...
					OAuthCommunicationException, NotAuthorizedException, BookNotFoundException, IOException, NetworkException 
	{
		...
		// Sort by update_dte (descending) so sync is faster. Specify 'shelf=all' because it seems babelio returns 
		// the shelf that is selected in 'My Books' on the web interface by default.
		final String urlBase = "http://www.babelio.com/review/list/%4$s.xml?key=%1$s&v=2&page=%2$s&per_page=%3$s&sort=date_updated&order=d&shelf=all";
		final String url = String.format(urlBase, page, perPage, mManager.getUserid());
        ...
        */
        ...
        String html = mManager.executeRaw(get, true);
				...
				<reviews start="3" end="4" total="933">
					<review>
						...
						<book>
							...
							<image_url>http://photo.babelio.com/books/1294108593m/951750.jpg</image_url>
							<small_image_url>http://photo.babelio.com/books/1294108593s/951750.jpg</small_image_url>
							<link>http://www.babelio.com/book/show/951750.The_Dying_Earth</link>
							...
							<authors>
								<author>
									...
									<image_url><![CDATA[http://photo.babelio.com/authors/1207604643p5/5376.jpg]]></image_url>
									<small_image_url><![CDATA[http://photo.babelio.com/authors/1207604643p2/5376.jpg]]></small_image_url>
									<link><![CDATA[http://www.babelio.com/author/show/5376.Jack_Vance]]></link>
						...
						<url><![CDATA[http://www.babelio.com/review/show/276860380]]></url>
						<link><![CDATA[http://www.babelio.com/review/show/276860380]]></link>
					...
					<review>
						...
						<book>
							...
							<image_url>http://www.babelio.com/images/nocover-111x148.jpg</image_url>
							<small_image_url>http://www.babelio.com/images/nocover-60x80.jpg</small_image_url>
			
							<link>http://www.babelio.com/book/show/2042540.The_Fallible_Fiend</link>
							<num_pages></num_pages>
							<format></format>
							<edition_information></edition_information>
							<publisher></publisher>
							...
							<authors>
								<author>
									...
									<image_url><![CDATA[http://photo.babelio.com/authors/1218217726p5/3305.jpg]]></image_url>
									<small_image_url><![CDATA[http://photo.babelio.com/authors/1218217726p2/3305.jpg]]></small_image_url>
									<link><![CDATA[http://www.babelio.com/author/show/3305.L_Sprague_de_Camp]]></link>
						...
						<url><![CDATA[http://www.babelio.com/review/show/273090417]]></url>
						<link><![CDATA[http://www.babelio.com/review/show/273090417]]></link>
						<owned>0</owned>
					</review>
	...
	protected void buildFilters() {
		...
		//			<id>276860380</id>
					.longBody("id", BA_REVIEW_ID)
		//			<book>
					.s("book")
		//				<id type="integer">951750</id>
						.longBody("id", BA_BOOK_ID)
		//				<isbn>0583120911</isbn>
