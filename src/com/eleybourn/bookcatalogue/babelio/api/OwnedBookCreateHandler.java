...
public class OwnedBookCreateHandler extends ApiHandler {
	...
	public static class InvalidIsbnException extends RuntimeException {
		...
		private static final long serialVersionUID = 3700079852867094447L;
	};
	...
	public OwnedBookCreateHandler(BabelioManager manager) {
		super(manager);
	}
	...
	/* 
	 *  URL: http://www.babelio.com/owned_books.xml
	 *	HTTP method: POST
	 *	Parameters:
	...
	public void create(String isbn, ArrayList<String> shelves) 
			throws IOException,	NotAuthorizedException, NetworkException, BookNotFoundException 
	{
		...
		} catch (com.eleybourn.bookcatalogue.babelio.BabelioManager.Exceptions.BookNotFoundException e) {
			throw new InvalidIsbnException();
		}

		HttpPost post = new HttpPost("http://www.babelio.com/owned_books.xml");
