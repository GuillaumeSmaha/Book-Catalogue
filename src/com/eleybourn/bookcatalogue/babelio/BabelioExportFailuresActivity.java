 ...
 */
public class BabelioExportFailuresActivity extends BindableItemListActivity 
{
	/** Key to store optional task ID hen activity is started */
	public static final String KEY_TASK_ID = "BabelioExportFailuresActivity.TaskId";
	/** DB connection */
	 ...
	 * 
	 */
	public BabelioExportFailuresActivity() {
	...
	private OnEventChangeListener m_OnEventChangeListener = new  OnEventChangeListener() {
		...
		public void onEventChange(Event event, EventActions action) {
			BabelioExportFailuresActivity.this.refreshData();
		}};
	...
	public static int getActivityId() {
		return UniqueId.ACTIVITY_BABELIO_EXPORT_FAILURES;
	}
	...
	public static void start(Activity from, long taskId) {
		Intent i = new Intent(from, BabelioExportFailuresActivity.class);
