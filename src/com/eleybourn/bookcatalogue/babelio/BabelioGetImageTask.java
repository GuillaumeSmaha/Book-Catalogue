...
/**
 * Background task to load an image for a BabelioWork from a URL. Does not store it locally; 
 * it will call the related Work when done.
 * 
 * @author Philip Warner
 */
public class BabelioGetImageTask implements SimpleTask {
	 ...
	 * BabelioWork object and Bitmap objects are much larger than JPG objects.
	 */
	private byte[] mBytes = null;
	/** Related work */
	private BabelioWork mWork;
	 ...
	 */
	public BabelioGetImageTask(String url, BabelioWork work) {
		mUrl = url;
		mWork = work;
	}
